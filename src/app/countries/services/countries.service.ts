...
export class CountriesService {
  ...
  getCountriesByRegion(region: Region[]): Observable<SmallCountry[]> {
    ...
    // transformamos el observable de tipo Country para ajustarlo a la interface de SmallCountry
  ...
  getCountryByAplhaCode(alphacode: string): Observable<SmallCountry> {
    // esta condición también se puede hacer a través de un operador de rxjs llamado filter -> ver función onCountryChanged
